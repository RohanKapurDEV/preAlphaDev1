 ...
 * storage for public keys with relevant metadata and SecureStorage for respective private keys.
 * 
...
export class WalletGenService {
  ...
  generateEtherWalletFromMnemonic(): Wallet {
    ...
    return wallet; // Replace return statements with those that isolate components of the return type for usage in storage mechanisms (e.g secureStore(wallet.privateKey) or maybe an SQL statemnt (STORE _id, pk, 'ethereum', 'date/time created') something idk)
  }
